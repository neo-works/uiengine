...
int main(int argc, char* argv[]) {
    char *doc =
    "<body id=\"test_id\">"
        "<button width=\"100\" height=\"60\" x=\"10\" y=\"10\" background=\"rgb(255,255,255)\">text</button>"
        "<button width=\"100\" height=\"60\" x=\"120\" y=\"10\" background=\"rgb(255,255,255)\">text</button>"
        "<button width=\"100\" height=\"60\" x=\"230\" y=\"10\" background=\"rgb(255,255,255)\">text</button>"
